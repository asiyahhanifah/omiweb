      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-info">
            <h3>OwmisArt</h3>
            <p>OwmisArt is an illustration commission website that helps commissioners who want to buy or collect art from illustrators</p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <div class="social-links">
              ...
              <a href="https://www.google.com/" target="_blank" class="google-plus"><i class="fa fa-google-plus"></i></a>
          ...
          <div class="col-lg-3 col-md-6 footer-newsletter">
            ...
            <p>To get to know us more, visit our newsletter</p>
